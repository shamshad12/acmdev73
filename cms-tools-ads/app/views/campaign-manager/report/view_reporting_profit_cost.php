<?php $user = $this->session->userdata('profile');?>
				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="reporting_profit_cost_list active"><a href="#reporting_profit_cost_list" data-toggle="tab">Profit and Cost Reporting List</a></li>                        
                     </ul>
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Profit and Cost Reporting List</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">
                              	 <form method="post" action="campaign_manager/reporting_profit_cost/generate" id="reprt_sbmt">	
								<div class="btn-group">
								...
								?>	      
								 ...
								 <div class="btn-group">
									<select class="m-wrap" id="shortcode-list" name="shortcode-list" style="width:150px;">
									 ...
									 if($shortcode['count']){
										 $operatorsData = "";
										for($i=0; $i<count($shortcode['rows']); $i++){
									 ?>
								 ...
								 <div class="btn-group">
									<select class="m-wrap" id="keyword-list" name="keyword-list" style="width:150px;">
										<option value="">- Choose Keyword -</option>
									 <?php 
									 if($keyword['count']){
										 $operatorsData = "";
										for($i=0; $i<count($keyword['rows']); $i++){
									 ?>
										<option value='<?php echo $keyword['rows'][$i]['name'];?>'><?php echo $keyword['rows'][$i]['name'];?></option>
									 <?php }
									 } ?>							 
									</select>
								 </div>
								 <!-- EOL OF SHORTCODE & KEYWORD -->
								 <div class="btn-group">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="Search by Campaign name, Shortcode, SID or Keyword" title="Search by Campaign name, Shortcode, SID or Keyword">
									<button class="btn green" title="search" type="button" onclick="loadReporting_Profit_Cost(1)"><i class="icon-search"></i></button>
								 </div>
								 <div class="btn-group">					
    ...
    <script src="assets/js/metronic/app/campaign-manager/report/reporting_profit_cost.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
	<script type="text/javascript">
		var deleteID = "";
		
		jQuery(document).ready(function() {		
			loadReporting_Profit_Cost(1);
		});
