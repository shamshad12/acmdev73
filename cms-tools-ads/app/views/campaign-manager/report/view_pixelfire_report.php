				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="traffic_reporting_list active"><a href="#traffic_reporting_list" data-toggle="tab">Pixel Fire Reporting List</a></li>                        
                     </ul>
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Pixel Fire Reporting List</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">
                              	<form method="post" action="campaign_manager/pixelfire_report/generate" id="reprt_sbmt">
								 	 <div class="btn-group">
								 ...
								 <div class="btn-group">
									<select class="m-wrap" id="ad-network" name="adnetwork" style="width:150px;">
								 ...
								 <div class="btn-group daterange4 hidden">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="search by txn_id" title="">
								 </div>
								 <div class="btn-group">
								 	<button class="btn green" type="button" title="search"  onclick="loadpixelfire_report(1)"><i class="icon-search"></i></button>
								 </div>
								 <div class="btn-group">					
    ...
    <script src="assets/js/metronic/app/campaign-manager/report/pixelfire_report.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
	<script type="text/javascript">
		var deleteID = "";
		
		jQuery(document).ready(function() {		
			loadpixelfire_report(1);
		});
