				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="traffic_reporting_list active"><a href="#traffic_reporting_list" data-toggle="tab">Country Overview List</a></li>                        
                     </ul>
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Country Overview List</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">
                              	 <form method="post" action="index.php/campaign_manager/country_overview/generate" id="country_overview_form">
								                    <!-- <div class="btn-group">
                                    ...
                                    <div class="btn-group">
                                      <button class="btn green" type="button" style="margin-top: -10px;" onclick="loadcountry_overview(1)"><i class="icon-search"></i></button> 
                                    </div> 
                      							<!-- <div class="btn-group">					
                      								<button class="btn green country_overview_btn" onclick="formsbmt()" type="button" style="margin-top:-10px" title="Download *.csv"><i class="icon-download"></i></button>
                      							</div> -->
                      						</form>
                              	<div id="table-append-today"Loading Today Data....></div>
    ...
    <script src="assets/js/metronic/app/campaign-manager/report/country_overview.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
	<script type="text/javascript">
		var deleteID = "";
		
		jQuery(document).ready(function() {		
			loadcountry_overview(1);
		});
