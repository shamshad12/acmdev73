				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="traffic_reporting_list active"><a href="#traffic_reporting_list" data-toggle="tab">Dashboard Reporting List</a></li>                        
                     </ul>
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Dashboard Reporting List</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">
                              	<form method="post" action="campaign_manager/dashboard_reporting/generate" id="reprt_sbmt">
								<div class="btn-group">
...
<!--								 <div class="btn-group">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" placeholder="Search By Campaign name, Shortcode, SID, ACM transaction id, MSISDN or keyword" title="Search By Campaign name, Shortcode, SID, ACM transaction id, MSISDN or keyword" type="text">
									<button class="btn green" type="button" onclick="loadDashboard_Reporting(1)"><i class="icon-search"></i></button>
								 </div>
								 <div class="btn-group">					
    ...
    <script src="assets/js/metronic/app/campaign-manager/report/dashboard_reporting.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
	<script type="text/javascript">
		var deleteID = "";
		
		jQuery(document).ready(function() {		
			loadDashboard_Reporting(1);
		});
