                           ...
                           <div class="portlet box blue portlet-list">
                              ...
                              <div class="portlet-body form">
								...
								<div class="btn-group">
								 ...
								 <div class="btn-group">
								      <select class="m-wrap" id="partners-list" name="partners-list" style="width:150px;">
								...
								<div class="btn-group">
								 ...
								 <button class="btn green" type="button" style="margin-top:-10px" title="Download *.csv" onclick="checkDateEntered()"><i class="icon-download"></i></button>
                              	 ...
                              	 <div id="info">Please click on campaign name to view hourly campaign details.</div>
	...
	<div id="show_detail" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="true" style="margin-left:-30%;width:1000px;">
        ...
        <div class="modal-footer" id="modal-body">
			<div  id="name_details"style="text-align: left;padding-bottom:20px;">
			</div>
			<div id="hourly_details">
