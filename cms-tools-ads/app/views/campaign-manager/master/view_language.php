				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="country_list active"><a href="#country_list" data-toggle="tab">Language List</a></li>
                        <li class="country_form "><a href="#country_form" data-toggle="tab">Language Form</a></li>
                     </ul>
                     <div class="tab-content">
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Language List</div>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="Seacrh by Id Or Language name" title="Seacrh by Id Or Language name">
									<button class="btn green" type="button" onclick="loadLanguage(1)" title="Search"><i class="icon-search"></i></button>
								 </div>
                      ...
                      <br />            
                           <div class="portlet box blue portlet-form">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Language Form</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">                              
                                 <form action="#" id="formcountry" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input name="language" id="language" maxlength="25" type="text" class="span6 m-wrap" />
										</div>
									</div>
    ...
    <script src="assets/js/metronic/app/campaign-manager/master/language.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
    ...
    <div id="delete" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="deleteLanguage()">Delete</button>
        </div>
    </div>
