				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="partners_list active"><a href="#partners_list" data-toggle="tab">Update Filter List</a></li>
                        ...
                        <br />  
                           <div class="portlet box blue portlet-list">
                              ...
                              <div class="portlet-body form">
								 <div class="btn-group">								
									<select class="m-wrap" id="limit" name="limit" style="width:60px;display:none">
                              ...
                              <div class="portlet-body form">                              
                                 <form action="#" id="formpartners" class="form-horizontal">
									...
									<div class="control-group"> 
										...
										<div class="controls">
											<input name="list_name" id="list_name" maxlength="25" type="text" class="span2 m-wrap"/>
										</div>
									</div>
									<div class="control-group">
    ...
    <script src="assets/js/metronic/app/campaign-manager/filterlist/filtertype.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
    ...
    <div id="delete" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="deleteFiltertype()">Delete</button>
        </div>
    </div>
