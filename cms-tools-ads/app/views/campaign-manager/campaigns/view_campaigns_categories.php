				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="campaigns_categories_list active"><a href="#campaigns_categories_list" data-toggle="tab">Categories List</a></li>
                        <li class="campaigns_categories_form "><a href="#campaigns_categories_form" data-toggle="tab">Categories Form</a></li>
                     </ul>
                     <div class="tab-content">
                        <div class="tab-pane active" id="campaigns_categories_list">
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Categories List</div>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="Search by Id, Category name or Description" title="Search by Id, Category name or Description">
									<button class="btn green" type="button" onclick="loadCampaigns_Categories(1)" title="Search"><i class="icon-search"></i></button>
								 </div>
                              	 <div id="table-append"></div>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane " id="campaigns_categories_form">
                           <!-- BEGIN DASHBOARD STATS -->
                      <br />            
                           <div class="portlet box blue portlet-form">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Categories Form</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">                              
                                 <form action="#" id="formcampaigns_categories" class="form-horizontal">
									<?php $this->load->view('layout/_errorhandling');?>
									<input name="id" id="id" maxlength="50" type="hidden" class="span6 m-wrap"/>							
									<div class="control-group">
										<label class="control-label">Categories Name<span class="required">*</span></label>
										<div class="controls">
    ...
    <script src="assets/js/metronic/app/campaign-manager/campaigns/campaigns_categories.js?<?php echo date('H:i:s');?>" type="text/javascript"></script>
    ...
    <div id="delete" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="deleteCampaigns_Categories()">Delete</button>
        </div>
    </div>
