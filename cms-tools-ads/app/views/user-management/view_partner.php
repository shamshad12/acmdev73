                           ...
                           <div class="portlet box blue portlet-list">
                              ...
                              <div class="portlet-body form">
								 ...
								 <div class="btn-group">								
									...
									<button class="btn green" type="button" onclick="loadPartner(1)">Search!</button>
								 </div>
								...
								<div class="portlet-title">
                                 ...
                                 <form action="#" id="formpartner" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input name="nama_partner" id="nama_partner" maxlength="50" type="text" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									<div class="control-group">
    ...
    <script src="assets/js/metronic/app/user-management/partner.js" type="text/javascript"></script>
