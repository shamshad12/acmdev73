				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
					...
					<div class="btn-group">
						<select name="filter_tipe_user_id" id="filter_tipe_user_id" data-required="1" class="span2">
    ...
    <div id="duplicate" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="duplicateKaryawan()">Yes</button>
        </div>
    </div>
