				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="publisher_list active"><a href="#publisher_list" data-toggle="tab">Publisher List</a></li>
                        <li class="publisher_form "><a href="#publisher_form" data-toggle="tab">Publisher Form</a></li>
                     </ul>
                     <div class="tab-content">
                        <div class="tab-pane active" id="publisher_list">
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Publisher List</div>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="Search by Id, Name, Phone number or email" title="Search by Id, Name, Phone number or email">
									<button class="btn green" type="button" onclick="loadPublisher(1)">Search!</button>
								 </div>
                              	 <div id="table-append"></div>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane " id="publisher_form">
                           <!-- BEGIN DASHBOARD STATS -->
                      <br />            
                           <div class="portlet box blue portlet-form">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Publisher Form</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">   
								<div class="portlet-title">
                                 ...
                                 <form action="#" id="formpublisher" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="store_id" id="store_id" data-required="1" class="span6 m-wrap">
												<option value="">-Publisher-</option>
												<?php 
													if($publishers['count']){
														for($i=0; $i<count($publishers['rows']); $i++){
												?>
												<option value="<?php echo $publishers['rows'][$i]['id'];?>"><?php echo $publishers['rows'][$i]['name'];?></option>
												<?php } } ?>
											</select>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input name="nama_publisher" id="nama_publisher" maxlength="50" type="text" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									<div class="control-group">
    ...
    <script src="assets/js/metronic/app/user-management/publisher.js" type="text/javascript"></script>
    ...
    <div id="delete" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="deletePublisher()">Delete</button>
        </div>
    </div>
