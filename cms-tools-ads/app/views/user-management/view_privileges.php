				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        <li class="privileges_list active"><a href="#privileges_list" data-toggle="tab">Privileges List</a></li>
                        <li class="privileges_form "><a href="#privileges_form" data-toggle="tab">Privileges Form</a></li>
                     </ul>
                     <div class="tab-content">
                        <div class="tab-pane active" id="privileges_list">
                        <br />  
                           <div class="portlet box blue portlet-list">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Privileges List</div>
                                 <div class="tools">
                              ...
                              <div class="portlet-body form">
								 ...
								 <div class="btn-group">								
									<input class="m-wrap" id="search" name="search" type="text" placeholder="Search by Id, User Name, Description or name" title="Search by Id, User Name, Description or name" >
									<button class="btn green" type="button" onclick="loadPrivileges(1)">Search!</button>
								 </div>
                              	 <div id="table-append"></div>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane " id="privileges_form">
                           <!-- BEGIN DASHBOARD STATS -->
                      <br />            
                           <div class="portlet box blue portlet-form">
                              <div class="portlet-title">
                                 <div class="caption"><i class="icon-reorder"></i>Privileges Form</div>
                                 <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                 </div>
                              </div>
                              <div class="portlet-body form">                              
                                 <form action="#" id="formprivileges" class="form-horizontal">
									<?php $this->load->view('layout/_errorhandling');?>
									<div class="control-group">
										<label class="control-label">Privileges ID<span class="required">*</span></label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label">Default Menu<span class="required">*</span></label>
										<div class="controls">	
											<select name="default_menu" id="default_menu" data-required="1" class="span6 m-wrap">
												<option value="">-Default Menu-</option>
												<?php 
													if($menus['count']){
														for($i=0; $i<count($menus['rows']); $i++){
												?>
												<option value="<?php echo $menus['rows'][$i]['id_menu'];?>"><?php echo $menus['rows'][$i]['level'].$menus['rows'][$i]['name'];?></option>
												<?php } } ?>
											</select>
										</div>
									</div>
    ...
    <script src="assets/js/metronic/app/user-management/privileges.js" type="text/javascript"></script>
    ...
    <div id="delete" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-footer">
            ...
            <button type="button" data-dismiss="modal" class="btn green" onClick="deletePrivileges()">Delete</button>
        </div>
    </div>
