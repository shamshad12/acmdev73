				...
				<div id="dashboard">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     <ul class="nav nav-tabs">
                        ...
                        <li class="templates_upload_form "><a href="#templates_upload_form" data-toggle="tab" title="Create WEB Template by uploading ZIP." onClick="clearFormEdit()">Templates Web/Wap Upload Form</a></li>
                     </ul>
