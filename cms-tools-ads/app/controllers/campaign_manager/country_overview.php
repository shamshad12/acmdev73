...
class country_overview extends Admin_Controller {
	...
	public function __construct() {
		...
		$this->load->model('campaign-manager/report/model_country_overview');
	...
	public function index() {
		...
		$this->data['pageTemplate']	= "campaign-manager/report/view_country_overview";
		$this->load->view('layout/main', $this->data);
	}

	public function loadcountry_overview(){
		$params = $_POST;
		
		$result = $this->model_country_overview->loadcountry_overview($params);		
	...
	public function generate(){
		...
		$result = $this->model_country_overview->generate($params);
