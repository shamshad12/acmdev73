...
class dashboard_reporting extends Admin_Controller {
	...
	public function __construct() {
		...
		$this->load->model('campaign-manager/report/model_dashboard_reporting');
	...
	public function index() {
		...
		#Get Data Campaign
		$this->data['campaigns'] = $this->model_campaigns->loadCampaignsSelect();
		...
		$this->data['pageTemplate']	= "campaign-manager/report/view_dashboard_reporting";
		$this->load->view('layout/main', $this->data);
	}

	public function loadDashboard_Reporting(){
		$params = $_POST;
		
		$result = $this->model_dashboard_reporting->loadDashboard_Reporting($params);		
		
		$result['pagination'] = $this->pagination($params['page'], $result['total'], $params['limit'], 'loadDashboard_Reporting');
	...
	public function generate(){
		...
		$result = $this->model_dashboard_reporting->generate($params);
		
		header('Content-Type: application/excel'); 
		header('Content-Disposition: attachment; filename="Dashboard-Reporting-'.date('t').'.csv"');
