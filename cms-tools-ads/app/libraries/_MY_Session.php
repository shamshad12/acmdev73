...
class MY_Session extends CI_Session
{
    ...
    function sess_write()
    {
        ...
        $this->userdata['user_data'] = $custom_userdata;
        $this->redis->multi()->delete($this->userdata['session_id'])->setex($this->userdata['session_id'], $this->sess_expiration, json_encode($this->userdata))->exec();
    ...
    function _set_cookie($cookie_data = NULL)
    {
        ...
        // Set the cookie
        setcookie($this->sess_cookie_name, $this->userdata['session_id'], $expire, $this->cookie_path, $this->cookie_domain, $this->cookie_secure);
    }
