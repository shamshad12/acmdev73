...
* ver 1.1
* support API MKU Payment Gateway v2.5.x
* support API MKU Payment Gateway v2.6.x
* support API MKU Payment Gateway v2.7.x
* support API MKU Payment Gateway v2.8.x
*
...
// tambahan parameter price, partner bisa set sendiri
        if($this->request['Type']=='RESERVE') $ardata['Price'] = $params['Price'];
// --
