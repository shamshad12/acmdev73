...
//define('MKU_DEFAULT_LOG','/usr/zingmobile/log/mkupayment2.1_request_log.txt');
//define('MKU_DEFAULT_LOGDIR','/usr/zingmobile/log/');
define('MKU_DEFAULT_URL','http://localhost/paymentgw/tester/index-test.php');
define('MKU_DEFAULT_LOG','/tmp/mkupayment2.1_request_log.txt');
define('MKU_DEFAULT_LOGDIR','/tmp/');
...
#print $url.'?'.$body;
		...
		$response = file_get_contents($url.'?'.$body);
		return $response;
