function loadShortcodes(page){		
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/shortcodes/loadShortcodes",
			dataType: "json",
			type: "POST",
			data: {
					'limit' : limit,
...
function edit(id){
	jQuery.ajax({
			url:  domain+"campaign_manager/shortcodes/getShortcodesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
			...
			success: function(data) {
										if(data.count){
											...
											inactiveTab('shortcodes_list');
											activeTab('shortcodes_form');
										} else {
...
function save(){
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/shortcodes/saveShortcodes",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
			...
			success: function(data) {
										if(data.success){
											...
											inactiveTab('shortcodes_form');
											activeTab('shortcodes_list');
										} else {
											success.hide();
                    						error.show();
										}
...
function deleteShortcodes(){
	if(deleteID != ""){
		jQuery.ajax({
				url:  domain+"campaign_manager/shortcodes/deleteShortcodes",
				dataType: "json",
				type: "POST",
				data: {
						'id' : deleteID
