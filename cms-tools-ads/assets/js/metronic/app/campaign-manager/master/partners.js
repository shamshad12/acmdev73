function loadPartners(page){		
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/partners/loadPartners",
			dataType: "json",
			type: "POST",
			data: {
					'limit' : limit,
...
/*function edit(id){
	jQuery.ajax({
			url:  domain+"campaign_manager/partners/getPartnersData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
...
function save(){
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/partners/savePartners",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
...
function deletePartners(){
	if(deleteID != ""){
		jQuery.ajax({
				url:  domain+"campaign_manager/partners/deletePartners",
				dataType: "json",
				type: "POST",
				data: {
						//'id' : deleteID
