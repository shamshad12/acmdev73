function loadCampaigns_Categories(page){		
	var limit  = $('#limit').val(),
		search = $('#search').val(),
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/campaigns_categories/loadCampaigns_Categories",
			dataType: "json",
			type: "POST",
			data: {
					'limit' : limit,
...
var FormValidation = function () {
    return {
        init: function () {
            var form = $('#formcampaigns_categories');
...
function edit(id){
	jQuery.ajax({
			url:  domain+"campaign_manager/campaigns_categories/getCampaigns_CategoriesData",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id
			...
			success: function(data) {
										if(data.count){
											...
											inactiveTab('campaigns_categories_list');
											activeTab('campaigns_categories_form');
										} else {
...
function save(){
	...
	jQuery.ajax({
			url:  domain+"campaign_manager/campaigns_categories/saveCampaigns_Categories",
			dataType: "json",
			type: "POST",
			data: {
					'id' : id,
			...
			success: function(data) {
										if(data.success){
											...
											inactiveTab('campaigns_categories_form');
											activeTab('campaigns_categories_list');
										} else {
											success.hide();
                    						error.show();
										}
...
function deleteCampaigns_Categories(){
	if(deleteID != ""){
		jQuery.ajax({
				url:  domain+"campaign_manager/campaigns_categories/deleteCampaigns_Categories",
				dataType: "json",
				type: "POST",
				data: {
						'id' : deleteID
